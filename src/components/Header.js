...
const Header = () => {
  ...
  return (
    <div className={`w-full flex fixed justify-center flex-row top-0         z-10
    border-b shadow-md py-4 font-semibold   text-center ${darkMode ? 'bg-black text-white':'bg-white text-black'}`}>
